    ...
    <>
      <DropdownMenu modal={false}>
        <DropdownMenuTrigger asChild>
          <button
            className="h-8 w-8 flex items-center justify-center text-text-muted hover:text-text-primary hover:bg-surface-hover rounded-full transition-colors outline-none focus:ring-2 focus:ring-brand-primary active:scale-95 duration-200"
    ...
    >
      ...
      >
        <div className="space-y-2 text-center">
          <div className="w-12 h-12 rounded-full bg-status-danger-border text-status-danger mx-auto flex items-center justify-center mb-2">
            <Trash2 size={24} />
          </div>
        ...
        <div className="grid grid-cols-2 gap-3 pt-2">
          <button
            onClick={onCancel}
            className="w-full py-2.5 rounded bg-surface-main border border-border-default text-text-secondary hover:text-text-primary hover:bg-surface-card font-bold transition-all text-xs uppercase tracking-wider"
          >
            Cancel
          </button>
