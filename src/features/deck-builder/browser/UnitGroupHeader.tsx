...
export const UnitGroupHeader = React.memo(function UnitGroupHeader({
  ...
  return (
    ...
    >
      <h2 className="text-purple-400 font-bold text-sm uppercase tracking-widest border-b border-white/5 pb-1 flex items-center justify-between max-w-[1920px] mx-auto">
        <span>
            {title}{" "}
