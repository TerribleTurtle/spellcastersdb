...
export function useDeckHotkeys() {
  ...
  useEffect(() => {
    const handleKeyDown = (e: KeyboardEvent) => {
        ...
        const { mode, saveDeck, clearDeck, saveTeam, teamName, activeTeamId, activeSlot } = store;
        ...
        if (isCtrl && e.shiftKey && (e.key === "Delete" || e.key === "Backspace")) {
             ...
             if (mode === "SOLO") {
                 ...
                 if (isSaved) {
                      ...
                      if (confirm("Are you sure you want to clear this deck? Unsaved changes will be lost.")) {
                          clearDeck();
                      }
                 }
            } 
