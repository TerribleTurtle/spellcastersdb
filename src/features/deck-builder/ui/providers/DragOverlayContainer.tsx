...
import { HelpCircle, Shield, Swords, Wand2 } from "lucide-react";
...
export function DragOverlayContainer() {
  ...
  const activeDragItem = useDeckStore(
        ...
        <div className="relative flex-1 overflow-hidden">
          ...
          {activeDragItem.category !== ENTITY_CATEGORY.Spellcaster && (
            <div className="absolute bottom-1 left-1 z-20">
              <RankBadge
                rank={
                  (activeDragItem as Unit).rank ||
                  (activeDragItem.category === ENTITY_CATEGORY.Titan ? "V" : "")
                }
