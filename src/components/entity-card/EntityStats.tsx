      ...
      {isSpellcaster && (
        <div
          className={cn(
            ...
            variant === "compact"
              ? "p-1.5 col-span-2"
              : "p-3 col-span-3 bg-surface-main/50"
          )}
        >
          <div
            className={cn(
          ...
          <div
            className={cn("flex", variant === "compact" ? "gap-1" : "gap-2")}
          >
            {[1, 2, 3].map((star) => (
              <div
                key={star}
                className={cn(
                  ...
                  variant === "compact"
                    ? "h-2 w-2"
                    : "h-2.5 w-2.5 ring-2 ring-offset-2 ring-offset-surface-card",
  ...
  return (
    <div
      className={cn(
        ...
        variant === "compact"
          ? "p-1 min-h-[50px]"
          : "p-3 hover:border-border-default bg-surface-main/50"
      )}
    >
      <div
        className={cn(
          variant === "compact"
            ? "scale-75 opacity-60 -mb-1"
            : "mb-1 opacity-60 scale-90 group-hover:scale-100 group-hover:opacity-100 transition-all duration-300"
        )}
      >
        {icon}
      </div>
