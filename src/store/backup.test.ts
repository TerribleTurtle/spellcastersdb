...
describe('Mass Delete & Backup', () => {
    ...
    describe('Mass Delete', () => {
        it('should delete multiple decks', () => {
            ...
            // Create 3 decks
            setDeckName("Deck 1"); saveDeck(); useDeckStore.setState({ currentDeck: { ...INITIAL_DECK, id: undefined, name: "" } });
            setDeckName("Deck 2"); saveDeck(); useDeckStore.setState({ currentDeck: { ...INITIAL_DECK, id: undefined, name: "" } });
            setDeckName("Deck 3"); saveDeck();
        ...
        it('should delete multiple teams', () => {
             ...
             setTeamName("Team 1"); saveTeam("id-1"); useDeckStore.setState({ activeTeamId: null });
             setTeamName("Team 2"); saveTeam("id-2"); useDeckStore.setState({ activeTeamId: null });
             setTeamName("Team 3"); saveTeam("id-3"); useDeckStore.setState({ activeTeamId: null });
    ...
    describe('Backup Service', () => {
        it('should generate valid backup data', () => {
             const { saveDeck, setDeckName, saveTeam, setTeamName } = useDeckStore.getState();
             
             setDeckName("Backup Deck"); saveDeck();
             setTeamName("Backup Team"); saveTeam("team-id");
