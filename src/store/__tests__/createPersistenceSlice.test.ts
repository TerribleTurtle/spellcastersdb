...
describe('createPersistenceSlice', () => {
    beforeEach(() => {
        useDeckStore.setState({
            ...
            teamName: "New Team",
            activeTeamId: null,
            teamDecks: [cloneDeck(INITIAL_DECK), cloneDeck(INITIAL_DECK), cloneDeck(INITIAL_DECK)],
        });
    });
    ...
    describe('saveTeamAsCopy', () => {
        it('should save team as a new copy', () => {
             ...
             const { saveTeam, saveTeamAsCopy, setTeamName, setTeamSlot } = useDeckStore.getState();
    ...
    describe('loadDeck', () => {
        it('should load deck and set as current', () => {
             const { saveDeck, setDeckName, loadDeck, clearDeck } = useDeckStore.getState();
             setDeckName("To Load");
             saveDeck();
