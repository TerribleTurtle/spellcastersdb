...
export default function NotFound() {
  return (
    <div className="flex min-h-[70vh] flex-col items-center justify-center text-center px-4">
      <div className="mb-6 rounded-full bg-surface-card p-8 ring-1 ring-white/10">
      ...
      <Link
        href="/"
        className="rounded-lg bg-brand-primary px-6 py-3 font-semibold text-text-primary transition-transform hover:scale-105 hover:bg-brand-primary/90"
      >
        Return to Safety
      </Link>
    </div>
