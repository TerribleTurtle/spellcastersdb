        ...
        <div className="space-y-6">
          ...
          <div className="bg-gradient-to-r from-brand-primary/20 to-surface-main border border-brand-primary/30 rounded-xl p-6">
            <div className="flex items-center gap-3 mb-2">
               ...
               <h3 className="text-xl font-bold text-white">{spellcaster.abilities.primary.name}</h3>
            </div>
            <p className="text-gray-300">{spellcaster.abilities.primary.description}</p>
          </div>
           ...
           <div className="bg-gradient-to-r from-brand-accent/20 to-surface-main border border-brand-accent/30 rounded-xl p-6">
            <div className="flex items-center gap-3 mb-2">
               ...
               <h3 className="text-xl font-bold text-white">{spellcaster.abilities.defense.name}</h3>
            </div>
            <p className="text-gray-300">{spellcaster.abilities.defense.description}</p>
          </div>
          ...
          <div className="bg-gradient-to-r from-brand-secondary/20 to-surface-main border border-brand-secondary/30 rounded-xl p-6 relative overflow-hidden">
            <div className="flex items-center gap-3 mb-2 relative z-10">
               ...
               <h3 className="text-xl font-bold text-white">{spellcaster.abilities.ultimate.name}</h3>
            </div>
            <p className="text-gray-300 relative z-10">{spellcaster.abilities.ultimate.description}</p>
          </div>
