...
export const metadata: Metadata = {
  ...
  description:
    "See what features are being built, what's requested by the community, and what's already live on SpellcastersDB.",
  openGraph: {
    title: "Development Roadmap | SpellcastersDB",
    description:
      "A transparent view into the development process of SpellcastersDB.",
  },
};
